...
<span class="bg-[#4796cc] text-white px-3 py-1 rounded text-sm font-bold uppercase tracking-wider shrink-0">Unit 3</span>
...
<p class="text-base text-green-800 mb-0 leading-relaxed">
...
<div class="text-2xl mb-2 text-green-600"><Icon name="Sprout" /></div>
...
<div class="text-2xl mb-2 text-blue-600"><Icon name="Anchor" /></div>
<h4 class="font-bold text-gray-800 mb-2 text-sm">
...
<div class="p-5 border border-gray-100 rounded-xl">
<div class="text-2xl mb-2 text-orange-600"><Icon name="Zap" /></div>
<h4 class="font-bold text-gray-800 mb-2 text-sm">
...
<Icon name="Check" class="text-green-500 flex-shrink-0" />
