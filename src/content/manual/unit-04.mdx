...
<span class="bg-[#4796cc] text-white px-3 py-1 rounded text-sm font-bold uppercase tracking-wider shrink-0">Unit 4</span>
...
<h3 class="text-xl font-bold text-gray-800 mt-12 mb-6">
    <span class="zh">4. 四大學習風格</span>
    <span class="en">4. Four Learning Styles</span>
</h3>
<p>
...
<h3 class="text-xl font-bold text-gray-800 mt-12 mb-6 font-black underline decoration-[#4796cc] decoration-4">
    <span class="zh">5. 兒童 vs. 成人教學</span>
    <span class="en">5. Teaching Children vs. Adults</span>
</h3>
<div class="overflow-x-auto border border-gray-200 rounded-2xl mb-12 custom-scrollbar">
...
<h3 class="text-xl font-bold text-gray-800 mt-12 mb-6 font-black underline decoration-[#4796cc] decoration-4">
    <span class="zh">6. 核心教學法</span>
    <span class="en">6. Core Teaching Methodologies</span>
</h3>
...
<h3 class="text-xl font-bold text-gray-800 mt-12 mb-6 font-black underline decoration-[#4796cc] decoration-4">
    <span class="zh">7. 教練的專業精神與素養</span>
    <span class="en">7. Professionalism & Interpersonal Skills</span>
</h3>
...
<h3 class="text-xl font-bold text-gray-800 mt-12 mb-6 font-black underline decoration-[#4796cc] decoration-4">
    <span class="zh">8. M+D3 教學模型</span>
    <span class="en">8. The M+D3 Teaching Paradigm</span>
</h3>
<div class="p-8 bg-blue-50/30 border border-blue-100 rounded-3xl mb-12">
    ...
    <div class="mt-8 pt-6 border-t border-blue-100 flex flex-col items-center justify-center gap-4 text-blue-800/60 font-medium text-sm">
        <span class="zh opacity-50">流程引導：</span>
        <div class="flex flex-wrap items-center justify-center gap-x-2 gap-y-3 px-4">
            <span class="whitespace-nowrap px-2 py-1 bg-blue-50 rounded-lg">Motivation</span> 
            <Icon name="ChevronRight" size={16} class="opacity-30" />
            <span class="whitespace-nowrap px-2 py-1 bg-blue-50 rounded-lg">Demonstration</span> 
            <Icon name="ChevronRight" size={16} class="opacity-30" />
            <span class="whitespace-nowrap px-2 py-1 bg-blue-50 rounded-lg">Description</span> 
            <Icon name="ChevronRight" size={16} class="opacity-30" />
            <span class="whitespace-nowrap px-2 py-1 bg-blue-600 text-white rounded-lg">Practical Drills</span>
        </div>
    </div>
</div>

<h3 class="text-xl font-bold text-gray-800 mt-12 mb-6 font-black underline decoration-green-500 decoration-4">
    <span class="zh">9. 優秀教練的十大核心特質</span>
    <span class="en">9. Ten Essential Qualities of a Great Instructor</span>
</h3>
