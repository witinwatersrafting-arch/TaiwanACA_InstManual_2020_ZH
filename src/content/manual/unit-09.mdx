...
<Callout type="danger" title="酒精、藥物與划行" enTitle="Alcohol, Drugs & Paddling">
...
<Callout type="warning" title="環境中的隱藏危險" enTitle="Environmental Hazards">
<ul class="text-base space-y-3 list-none pl-0 m-0">
