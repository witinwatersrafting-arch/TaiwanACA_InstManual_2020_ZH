...
<span class="font-bold text-blue-700 block mb-1 text-sm uppercase tracking-tighter">Catch - <span class="zh">抓水</span><span class="en">Catch</span></span>
...
<div class="p-4 border rounded-xl bg-blue-50/50 shadow-sm">
<span class="font-bold text-blue-700 block mb-1 text-sm uppercase tracking-tighter">Power - <span class="zh">動力</span><span class="en">Power</span></span>
<p class="text-sm m-0 text-slate-600 leading-relaxed">
...
<div class="p-4 border rounded-xl bg-blue-50/50 shadow-sm">
<span class="font-bold text-blue-700 block mb-1 text-sm uppercase tracking-tighter">Recovery - <span class="zh">復位</span><span class="en">Recovery</span></span>
<p class="text-sm m-0 text-slate-600 leading-relaxed">
...
<li class="p-4 bg-slate-50 rounded-xl border border-slate-100">
<strong class="text-slate-900 text-sm block mb-1"><span class="zh">船體靜穩 (Quiet Boat)：</span><span class="en">Quiet Boat:</span></strong>
...
<Callout type="warning" title="教學核心原則" enTitle="Core Pedagogical Principle">
<span class="zh">學員必須先學習如何有效地划行，初期的重點應放在「基礎技巧」而非「操控動作」。透過重複練習基礎技巧，能大大增加掌握操控動作的成功機會。若省略此過程，學員的操控表現往往不盡理想。</span>
<span class="en">Initial emphasis must be on fundamental skills rather than maneuvers. Practicing basic skills first leads to an increased chance of success in mastering maneuvers. If the process is abbreviated, maneuvers may be poorly executed.</span>
</Callout>
